...
export function RatioSelector({ onAspectChange }: RatioSelectorProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      <select 
        value={aspect} 
        onChange={(e) => handleChange(e.target.value as '1:1' | '16:9' | '4:3' | '9:16' | '4:6')}
